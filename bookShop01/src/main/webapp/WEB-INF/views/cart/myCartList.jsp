			...
			<tr style="background:#33ff00" >
			 ...
			 <tr>       
               <form name="frm_order_all_cart">
					...
					<td class="price"><span>${item.goods_sales_price }원</span></td>
					<td>
					   <strong>
	...
	<tbody>
		...
		<tr cellpadding=40  align=center >
	       ...
	       <td>
	          ...
	          <fmt:formatNumber  value="${totalGoodsPrice+totalDeliveryPrice-totalDiscountedPrice}" type="number" var="total_price" />${total_price}원</p>
