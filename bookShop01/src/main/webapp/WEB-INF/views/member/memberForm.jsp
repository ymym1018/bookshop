...
function selChange(value){
		document.frm_mod_member.sel_email2.value = value;
...
<body>
   <h3>필수입력사항</h3>
   <form name = "frm_mod_member" action="${contextPath}/member/addMember.do" method="post">   
   <div id="detail_table">
      <table>
         <tbody>
            <tr class="dot_line">
            ...
            <tr class="dot_line">
               ...
               <td><input size="10px"   type="text" name="email1" /> @ <input  size="10px"  type="text"name="email2" /> 
                    <select name="email2" onChange="selChange(this.value)"   title="직접입력">
